        ...
        <form action={formAction} className="flex-1 flex flex-col pb-9 text-gray-900">
          <div className="flex flex-col space-y-5">
            <label className="flex flex-col space-y-2">
              ...
              <input value={email} onChange={e => setEmail(e.target.value)} name="email" type="email" className="border border-gray-300 rounded-md px-2.5 py-1"/>
            </label>
            <label className="flex flex-col space-y-2">
              <h3 className="tracking-wide">パスワード</h3>
              <input value={password} onChange={e => setPassword(e.target.value)} name="password" type="text" className="border border-gray-300 rounded-md px-2.5 py-1"/>
            </label>
          </div>
